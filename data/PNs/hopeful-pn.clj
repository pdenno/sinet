...
{:initial-marking [1 0 0 0 0], ; All the :rep here are typed in. Might be okay!
   ...
   [{:name :m1-start-job,
    ...
    {:name :m1-move-off,
     ...
     :type :exponential,
     :rate 1.0,
     :rep {:clk 2030.0781 :act :m1-move-off :m :m1 :bf :b1 :n 0 :mjpact :bj :j 1705 :line 106}
     :visible? true}
    {:name :m2-start-job,
     :tid 40,
     :type :exponential,
    ...
    {:name :m2-move-off,
     ...
     :type :exponential,
     :rate 1.0,
     :rep {:clk 2032.3884 :act :m2-move-off :m :m2 :ent 2028.5745 :mjpact :ej :j 1705 :line 112}
     :visible? true}],
   :arcs
   [{:aid 74, :source :place-1, :target :m2-start-job, :name :aa-74, :type :normal, :multiplicity 1, :bind {:jtype :blue}}
    ...
    {:aid 76, :source :place-2, :target :m1-move-off, :name :aa-76, :type :normal, :multiplicity 1, :bind {:jtype :blue}}
    {:aid 77, :source :m1-move-off, :target :place-3, :name :aa-77, :type :normal, :multiplicity 1, :bind {:jtype :blue}, :priority 1}
    ...
    {:aid 80, :source :place-4, :target :m2-move-off, :name :aa-80, :type :normal, :multiplicity 1, :bind {:jtype :blue}}
    {:aid 81, :source :m2-move-off, :target :place-1, :name :aa-81, :type :normal, :multiplicity 1, :bind {:jtype :blue}, :priority 1}
