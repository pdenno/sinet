...
;;; ./MJPdes -i ~/Documents/git/sinet/data/SCADA-logs/scada-3m-2j.clj -o ~/Documents/git/sinet/data/SCADA-logs/fitness-test1-3m-2j-out.clj
(map->Model
 {:line 
  ...
  :entry-point :m1
  :params {:warm-up-time 2000 :run-to-time 5000}
